...
{
	public sealed class MapDemoMutator : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
	{
		...
		void _onGui()
		{
			...
			GUILayout.Label($"Latitude: {_current.x}");
			GUILayout.Label($"Longitude: {_current.y}");
		}
